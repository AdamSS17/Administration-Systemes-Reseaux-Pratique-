...
# on va dans le Global Configuration Mode avec la commande CONFIGURE TERMINAL et on lance la commande ip dhcp excluded-address 192.168.1.1 192.168.1.9
...
# on va dans le Global Configuration Mode avec la commande CONFIGURE TERMINAL et on lance les commandes "ip dhcp pool LAN-POOL" puis "network 192.168.1.0 255.255.255.0 " puis "default-router 192.168.1.1" enfin "dns-server 8.8.8.8"
# retourner en mode privilegie avec la commande END avant de sauvegarder   avec "copy run start"
